                ...
                <nav class="nav-wrapper">
                    <div class="page-wrapper">
                        ...
                        <ul class="right header-menu">
                            <li><a href="<s:url action='role/view/%{user.role.name}' namespace="/security"/>">${user.role.name}</a></li>
                            <li><a href="<s:url action='view/%{user.id}' namespace="/member"/>">My Account</a></li>
                            <li><a href="<s:url action='perform_logout' namespace="/auth"/>" class="waves-effect waves-light btn btn-error">Logout</a></li>
                        </ul>
                    </div>
                </nav>
